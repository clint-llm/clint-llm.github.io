...
H1N1 influenza virus is an orthomyxovirus and produces virions that are 80 to 120 nm in diameter, with an RNA genome size of approximately 13.5 kb. The swine influenza genome has 8 different regions which are segmented and encode 11 different proteins:
...
The initial and best step in management should be to prevent swine flu. Specifically, with prevention of swine flu in swine, prevention of transmission of swine flu from swine-to-humans, and prevention of human-to-human spread.
